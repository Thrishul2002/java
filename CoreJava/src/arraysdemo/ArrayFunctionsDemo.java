...
public class ArrayFunctionsDemo {
	...
	public static void main(String[] args) {
		...
		int[] n1={22,45,47,12,12,-2};
		        ...
		        System.out.print("n1 Array Contents : ");
		        for (int k:n1){
		            System.out.print(k+" ");
		        }
		        System.out.println("\n");
		        ...
		        System.out.println("\nn2 Array contents after Partial Copying: "+ Arrays.toString(n2));

		        //Copying Small Arrays- copyOf() method
		        int[] copyOfn1=Arrays.copyOf(n1,n1.length);
		        System.out.println("\nNew Array contents after  Copying: "+ Arrays.toString(copyOfn1));

		        //Sort Array - Quick Sort Algorithm
		        Arrays.sort(n3);
		        System.out.println("\nn3 Array contents after Sorting :"+ Arrays.toString(n3));

		        System.out.println("\n************* Binary Search **************");
		        Arrays.sort(copyOfn1); //Array needs to be sorted for binarySearch() Operation
		        System.out.println("\nNew Array Contents : "+Arrays.toString(copyOfn1));
